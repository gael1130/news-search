...
def load_ranking_sources(credentials, sheet_name="ranking_clean"):
    """
    ...
    return useful_sources, useless_sources
...
def get_or_create_worksheet(news_searches_sheet, worksheet_name):
    try:
        ...
        worksheet.append_row(['Titre', 'Source', 'Utilité', 'Publication', 'Année', 'Lien', 'name', 'lire en ligne', 'périodique', 'date', 'source balise'])
    return worksheet